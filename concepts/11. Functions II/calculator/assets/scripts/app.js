...
addBtn.addEventListener("click", add.bind(this, "addition"));
subtractBtn.addEventListener("click", subtract.bind(this, "subtraction"));
multiplyBtn.addEventListener("click", multiply.bind(this, "multiplication"));
divideBtn.addEventListener("click", divide.bind(this, "division"));